...
public class ParkingLot
{
    ...
    // all parking floors, identified their floor number
    ...
    private ParkingLot()
    {
        ...
        //  should also initialize max spot counts.
    ...
    // The following method is 'synchronized' to allow multiple entrances
    ...
    public synchronized ParkingTicket getNewParkingTicket(Vehicle vehicle) throws ParkingFullException
    {
        ...
        ParkingTicket ticket = new ParkingTicket(ParkingTicketStatus.ACTIVE);
    ...
    {
        for (int floorNumber : parkingFloors.keySet())
            if (!parkingFloors.get(floorNumber).isFull())
                return false;
        return true;
    }
